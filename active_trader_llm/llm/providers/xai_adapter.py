...
class XAIAdapter(LLMClient):
    ...
    def _convert_messages(self, messages: List[LLMMessage]) -> List[Dict[str, str]]:
        """Convert LLMMessage to xAI format (same as OpenAI)"""
        return [
    ...
    def _make_request(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Make HTTP request to xAI API with retries"""
        headers = {
    ...
    def generate_structured(
        ...
        **kwargs
        ...
        """Generate structured JSON response using xAI API"""
        temperature = self._normalize_temperature(temperature)
...
# Register provider
LLMClientFactory.register_provider("xai", XAIAdapter)
